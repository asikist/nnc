...
data_energy = np.loadtxt("energies_directed.csv")
oc_trajectories = np.loadtxt("oc_trajectory_directed.csv")
nnc_trajectories = np.loadtxt("nnc_trajectory_directed.csv")
